...
Открой в браузере https://stroova.ru, зайди в словарь и посмотри любое слово — в блоке «Транскрипция» должны быть IPA вроде `/həlˈəʊ/` (UK) и `/həlˈoʊ/` (US), а не просто слово в слэшах.
