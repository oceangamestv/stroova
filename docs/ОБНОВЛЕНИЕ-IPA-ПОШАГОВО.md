...
Приглашение станет примерно таким: `root@vm1147925:~/stroova#`
...
- Когда снова появится приглашение `root@vm1147925:~/stroova#` — обновление IPA завершено.
...
Открой в браузере свой сайт (например `https://147.45.196.155`), зайди в словарь и посмотри любое слово — в блоке «Транскрипция» должны быть IPA вроде `/həlˈəʊ/` (UK) и `/həlˈoʊ/` (US), а не просто слово в слэшах.
